...
void SendMessage()
{
  ...
  mySerial.println("AT+CMGS=\"+94770421544\"\r"); // Replace x with mobile number
  delay(1000);
...
void MakeCall()
{
  mySerial.println("ATD+94770421544;"); // ATDxxxxxxxxxx; -- watch out here for semicolon at the end!!
